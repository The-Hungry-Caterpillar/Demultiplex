...
def find_mean(file):   
	...
	array=np.zeros(args.read_length)
	f=gzip.open(file, 'rt')
	#f=open(file)
	i=0
...
#for testfile:
#python mean_quality_distribution.py -f test_files/long_R1.fastq -l 101 -nr 250 -t test_plot -d distribution_plots

#number of records in actual files:
#363246735